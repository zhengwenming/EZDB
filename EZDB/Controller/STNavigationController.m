...
//  EZDB
//
//  Created by zhengwenming on 2016/11/13.
...
@interface STNavigationController ()<UIGestureRecognizerDelegate,UINavigationControllerDelegate>
...
@property(nonatomic,strong)STAnimatedTransitioning * animationTransition;
@end
...
{
    self.animationTransition.navigationOperation = operation;
    self.animationTransition.navigationController = self;
...
- (STAnimatedTransitioning *)animationTransition
{
    if (_animationTransition == nil) {
        _animationTransition = [[STAnimatedTransitioning alloc]init];
...
- (NSArray<UIViewController *> *)popToViewController:(UIViewController *)viewController animated:(BOOL)animated
{
    ...
    _animationTransition.removeCount = removeCount;
    return [super popToViewController:viewController animated:animated];
}
- (NSArray<UIViewController *> *)popToRootViewControllerAnimated:(BOOL)animated
{
    [_screenshotImgs removeAllObjects];
    [_animationTransition removeAllScreenShot];
...
- (void)dragEnd
{
    ...
    if (translateX <= 40) {
        ...
        [UIView animateWithDuration:0.3 animations:^{
            ...
            // [_screenshotImgs removeLastObject];
            [self.animationTransition removeLastScreenShot];
        }];
    }
}
