...
const static CGFloat kCustomIOS7AlertViewCornerRadius              = 4;
...
- (IBAction)customIOS7dialogButtonTouchUpInside:(id)sender
{
    if (delegate != NULL)
    {
        [delegate NBAlertViewDialogButtonTouchUpInside:self clickedButtonAtIndex:[sender tag]];
    }
...
- (UIView *)createContainerView
{
    ...
    dialogContainer.layer.shadowRadius = cornerRadius ;
...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i=0; i<[buttonTitles count]; i++)
    {
        ...
        if (i==0) {
            ...
            closeButton.backgroundColor = kBtnBackGroudColor;
        }else{
            NSString *btnName = [closeButton titleForState:UIControlStateNormal];
            if ([btnName isEqualToString:@"确定"
                ]){
                closeButton.backgroundColor = kBtnBackGroudColor;
            }
            closeButton.backgroundColor = kRegBackGroudColor;
            closeButton.layer.borderColor = K204GrayColor.CGColor;
            [closeButton setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
        }
        [closeButton setFrame:CGRectMake(i * buttonWidth+10, container.bounds.size.height - buttonHeight-20, buttonWidth-20, buttonHeight)];
