...
@interface WmPickerViewController ()
...
@implementation WmPickerViewController
...
- (void)cancel:(id)sender {
    if (self.imagePickerDelegate && [self.imagePickerDelegate conformsToProtocol:@protocol(WmImagePickerDelegate)]) {
...
- (void)confirm:(id)sender {
    if (self.imagePickerDelegate && [self.imagePickerDelegate conformsToProtocol:@protocol(WmImagePickerDelegate)]) {
        [self.imagePickerDelegate imagePicker:self didFinished:[self getSubImage]];
    }
}
